// 改訂 Phase 11: usePendingProblemHydration / Phase 12: 推薦カード / Phase 13: 説明カード
"use client";
...
export function ProjectPlannerPanel() {
  ...
  return (
    <YStack gap="$4" padding="$4" maxWidth={960}>
      ...
      <AlgorithmRecommendationCard problem={pp.problem} /> {/* (Phase 12-4) */}
      <ExplanationCard problem={pp.problem} /> {/* (Phase 13-4) */}
      <ComparisonCard problem={pp.problem} /> {/* (Phase 14-7) */}
      ...
      {pp.comparison ? <BenchmarkTable entries={pp.comparison.entries} /> : null}
    </YStack>
  );
}
