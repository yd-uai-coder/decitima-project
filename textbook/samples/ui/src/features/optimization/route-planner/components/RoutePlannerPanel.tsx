// DeciTima samples │ Phase 4(改訂 Phase 11: usePendingProblemHydration / Phase 12: 推薦カード / Phase 13: 説明カード / Phase 14: LLM比較カード)
"use client";
...
export function RoutePlannerPanel() {
  ...
  return (
    <YStack gap="$4" padding="$4" maxWidth={960}>
      ...
      <AlgorithmRecommendationCard problem={rp.problem} /> {/* (Phase 12-4) */}
      <ExplanationCard problem={rp.problem} /> {/* (Phase 13-4) */}
      <ComparisonCard problem={rp.problem} /> {/* (Phase 14-7) */}
