// DeciTima samples │ Phase 5(改訂 Phase 11: usePendingProblemHydration / Phase 12: 推薦カード / Phase 13: 説明カード / Phase 14: LLM比較カード)
"use client";
...
export function NetworkDesignerPanel() {
  ...
  return (
    <YStack gap="$4" padding="$4" maxWidth={960}>
      ...
      <AlgorithmRecommendationCard problem={nd.problem} /> {/* (Phase 12-4) */}
      <ExplanationCard problem={nd.problem} /> {/* (Phase 13-4) */}
      <ComparisonCard problem={nd.problem} /> {/* (Phase 14-7) */}
